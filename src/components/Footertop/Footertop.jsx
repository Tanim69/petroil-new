...
import footlogo from '../../../src/assets/footlogo.png'


const Footertop = () => {
    return (
        <div className=' bg-[#1F1F1F] md:w-full'>

            <div className='px-6 md:px-0  max-w-container mx-auto md:flex'>

                <div className='md:w-[40%] '>

                    <img className=' md:pt-[148px] pt-[20px] md:pb-[33px]' src={footlogo} alt="footlogo" />
                    <div className='flex items-center pb-[15px] gap-x-[5px] '>
                        ...
                        <p className='text-white font-pops text-[14px] '>mail@yourcompany.com</p>
                    </div>
                    ...
                    <div className=' flex items-center pb-[15px] gap-x-[5px] '>
                        ...
                        <p className='text-white font-pops text-[14px]'>+896 120 5889 (Toll free)</p>
                    </div>


                    <div className='flex items-center pb-[41px] gap-x-[5px] '>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p className='text-white font-pops text-[14px]'>101 Baker Street, New York, USA, 12345</p>
                    </div>
                    {/* icon flex */}

                    <div className='flex md:pb-[170px] pb-[30px] gap-x-[18px]'>

                        <div className='bg-[#F40404] h-[29px] w-[29px] rounded-full top:0 left:0'>
                            <svg className='mt-[7px] ml-[6px]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <div className='md:w-[20%] text-white'>


                    <h3 className='md:pt-[176px] text-base font-pops font-bold pb-[21px]'>Company</h3>
                    <h3 className='text-[14px] font-pops font-normal pb-[15px] '>Home</h3>
                    <h3 className='text-[14px] font-pops font-normal pb-[15px] '>About</h3>
                    <h3 className='text-[14px] font-pops font-normal pb-[15px] '>Service</h3>
                    <h3 className='text-[14px] font-pops font-normal '>Gallary</h3>


                </div>

                <div className='md:w-[20%]  text-white'>
                    <h3 className='md:pt-[176px] text-base font-pops font-bold pb-[21px]'>Others</h3>
                    <h3 className='text-[14px] font-pops font-normal pb-[15px] '>Blog</h3>
                    <h3 className='text-[14px] font-pops font-normal pb-[15px] '>Contact</h3>
                    <h3 className='text-[14px] font-pops font-normal pb-[15px] '>Terms & Conditions</h3>
                    <h3 className='text-[14px] font-pops font-normal '>Privacy Policy</h3>
                ...
                <div className='md:w-[20%] text-white'>
                    ...
                    <h2 className='text-white md:pt-[176px] font-bold text-base pb-[21px]'>Certificate</h2>

                    <div className='flex gap-x-[5px] flex-end'>
                        <div className='bg-[#fff] w-[110px] h-[44px] rounded'>
                            <h3 className='text-[#008AD8] text-[24px] font-bold font-pops pl-[9px]'>ISO88</h3>
                            <p className='text-[#008AD8] text-[8px] font-bold font-pops mt-[-5px] pl-[9px]' >Environmentally Safe</p>
                        </div>

                        <div className='bg-[#fff] w-[110px] h-[44px] rounded'>

                            <h3 className='text-[#980077] font-bold text-[14px] pl-[11px] py-[10px]'>Liquid <span className='text-[#009818]'>Green</span> </h3>
