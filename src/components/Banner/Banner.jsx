...
const Banner = () => {
    return (
        ...
        <div className='bg-banner md:py-[257px] bg-cover bg-center bg-no-repeat bg-overlay relative after:content-[""]  after:absolute after:top-0 after:left-0 after:h-full after:w-full after:bg-overlay after:z-[-1] z-[-1] py-[60px]'>
